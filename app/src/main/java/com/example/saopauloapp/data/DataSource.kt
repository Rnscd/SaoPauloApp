...
object DataSource {
    ...
    val restaurantes = listOf<RestauranteLocal>(
        ...
        RestauranteLocal("A casa do porco", R.drawable.acasadoporco, "Av. São Luiz 140, 4º andar – República", R.string.scasadoporco),
        RestauranteLocal("Figueira Rubaiyat", R.drawable.figueirarubaiyat, " Rua Haddock Lobo, 1738 – Jardim Paulista", R.string.safiguieira),
    ...
    val parques = listOf<ParquesLocal>(
        ...
        ParquesLocal("Parque Villa Lobos", R.drawable.aguabranca, "Av. Prof. Fonseca Rodrigues, 2001 – Alto de Pinheiros", R.string.spqvilla)
    ...
    val shoppings = listOf<ShoppingLocal>(
        ...
        ShoppingLocal("Morumbi Shopping", R.drawable.morumbi, "Av. Roque Petroni Júnior, 1089, Jardim das Acácias", R.string.sshcenter),
